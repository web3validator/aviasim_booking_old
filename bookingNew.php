        ...
        if ($has_gift) {
            ...
            $query2 = $wpdb->prepare(
                "SELECT COUNT(*)
                       ...
                       WHERE pm1.meta_key = 'booking_gift_code'
                         AND pm1.meta_value = %s
                         AND pm2.meta_key = 'booking_bookingtype'
            ...
            function isGiftCodeValid($giftCode, $bookingtype) {
                ...
                $query = $wpdb->prepare(
                    "SELECT p.ID
                     ...
                     AND pm.meta_key = 'booking_bookingtype'
                     AND pm.meta_value = %s",
                    array($giftCode, $bookingtype)
                );
            ...
            $existingPostID = isGiftCodeValid($giftCode, $bookingtype);
            ...
            if ($date) {
                ...
                if ($type === 'Boeing') {
                    ...
                    $existing = Order::where_and(
                        ...
                        [
                            'post_status' => ['payment-success', 'payment-pending', 'free-created'],
                            'meta_query'  => [
                                [
...
//        }
    ...
    public static function available_dates($type = 'Boeing'): array
    {
